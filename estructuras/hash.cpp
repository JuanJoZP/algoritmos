...
class HashTel {
  ...
  vector<tuple<string, string, int>> table =
      vector<tuple<string, string, int>>(size_h);
...
int main() {
  ...
  tel.addValue("3215700339",
               tuple<string, string, int>{"3215700339", "Juan Jose", 17});
  tel.addValue("3216474294",
               tuple<string, string, int>{"3216474294", "Arnulfo", 23});
  tel.showTable();
